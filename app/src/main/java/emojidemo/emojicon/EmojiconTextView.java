...
public class EmojiconTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private void init(AttributeSet attrs) {
        if (attrs == null) {
            ...
            TypedArray a = getContext().obtainStyledAttributes(attrs, Emojicon);
            mEmojiconSize = (int) a.getDimension(0, getTextSize());
            mTextStart = a.getInteger(2, 0);
            mTextLength = a.getInteger(1, -1);
            a.recycle();
        }
        setText(getText());
    }
